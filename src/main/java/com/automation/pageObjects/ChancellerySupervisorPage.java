...
//	public static By Country_Article22 = By.xpath("//span[contains(text(),'" + country + "')]");
	public static By Country_Article22 = By.xpath(String.format("//span[contains(text(),'%s')]", country));
	...
	public WebElement getCountry_Afghanistan() {
		return driver.findElement(Country_Article22);
	}
